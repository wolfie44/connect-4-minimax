...
// GameDev.tv 
// Handle the creation of a session a player is hosting
public class HostGameManager : IDisposable
{
    ...
    public string GetLobbyCode() { return joinCode; }

    private const int MaxConnections = 2;
    private const string GameSceneName = "GameNetwork";
    ...
    public async Task StartHostAsync()
    {
        ...
        try
        {
            ...
            string playerName = PlayerPrefs.GetString(Constants.PlayerNameKey, "Unknown");
